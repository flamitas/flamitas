...
# Hi there! I'm Alejandro Borges 👋

### Full Stack Developer | Angular | Node.js | NestJS

Passionate about building modern web applications, clean user interfaces, scalable backend services, and practical digital solutions.
...
**Mar 2024 – Present** · Independent / Remote

- Develop reusable UI components with a component-based architecture using Angular and TypeScript.
- Build backend RESTful APIs with Node.js and Express.js, including validation, error handling, and authentication flows.
- Integrate SQL and NoSQL databases such as MySQL, PostgreSQL, and MongoDB for data persistence and query optimization.
- Work with Git-based development workflows using feature branches, pull requests, clean commits, and systematic debugging.
- Improve application performance, accessibility, and SEO following modern web development best practices.
- Produce technical documentation and maintain organized project structures for easier long-term maintenance.

**Core stack:** Angular, TypeScript, JavaScript, Node.js, Express.js, MySQL, PostgreSQL, MongoDB, Git, GitHub

### 🍔 Operador Integral | Burger King
**Oct 2023 – Mar 2024**

- Delivered fast and accurate customer service in a high-pressure environment.
- Processed orders using point-of-sale systems and followed operational procedures.
- Strengthened teamwork, communication, adaptability, and problem-solving under pressure.
...
- Exploring new AI tools and experimenting with practical automations.
